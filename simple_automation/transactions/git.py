...
def track(context: Context, path: str, msg: str):
    pass

def push(context: Context, path: str):
    pass

def commit_all(context: Context, path: str, msg: str):
    """
    Add all Checkout (and optionally update) the given git repository to dst.
    """
    url = _template_str(context, url)
    dst = _template_str(context, dst)
    check_valid_path(dst)
